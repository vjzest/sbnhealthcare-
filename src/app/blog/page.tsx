        ...
        <main className="bg-slate-50 min-h-screen">
            ...
            <section className="py-24 md:py-32">
                <div className="container mx-auto px-4">
                    {blogPosts.length === 0 ? (
                        <div className="text-center py-20 text-slate-400 font-bold">Stay tuned for more insights coming soon!</div>
                    ) : (
                            ...
                            {blogPosts.map((post: any) => (
                                ...
                                >
                                    ...
                                    <div className="p-8 md:p-10">
                                        ...
                                        <h3 className="text-2xl font-black text-[var(--secondary-color)] leading-tight mb-4 group-hover:text-[var(--primary-color)] transition-colors">
                                            {post.title}
                                        </h3>
